...
class FactorEvaluator:
    ...
    def __init__(self, factors: Sequence[str] | None = None) -> None:
            ...
            records.append(
                {
                    ...
                    "IC": ic_mean,
                    "rank_IC": float(rank_series.mean()) if not rank_series.empty else np.nan,
                    "IC_mean": ic_mean,
                    "IC_std": ic_std,
                    "ICIR": icir,
                }
    ...
    def _prepare(
        ...
        return prepared, factor_columns
